...
const CORE_TESTS = [
  ...
  'tests/rich-text-parser.test.js',
  'tests/known-issues-regression.test.js',
  'tests/known-issues-2026-07-26-regression.test.js',
  'tests/known-issues-followup-regression.test.js',
  'tests/known-issues-drawing-regression.test.js',
  'tests/known-issues-2026-09-05-regression.test.js',
  'tests/known-issues-2026-09-09-regression.test.js',
  'tests/teaching-tools-page-state.test.js',
  'tests/teaching-tools-wiring.test.js',
  'tests/dialog-confirm-queue.test.js',
  'tests/gif-pointer-persistence.test.js',
  'tests/main-drawing-engine-dependency.test.js',
  'tests/keyboard-undo-mid-stroke.test.js',
  'tests/discard-current-stroke-break-state.test.js',
  'tests/modal-resize-self-heal.test.js',
  'tests/time-display-state-sync.test.js',
  'tests/gif-save-quota-notice.test.js',
  'tests/confirm-modal-early-bindings.test.js',
  'tests/config-import-proto-pollution.test.js',
  'tests/shape-polygon.test.js',
  'tests/selection-history-entry-redraw.test.js',
  'tests/text-escaping-guards.test.js',
  'tests/toast-manager.test.js',
  'tests/timer-title-escaping.test.js',
  'tests/timer-audio-fallback.test.js',
  'tests/export-page-readiness.test.js',
  'tests/random-picker.test.js',
  ...
  'tests/alignment-guides.test.js',
  'tests/alignment-snap-wiring.test.js',
  'tests/storage-fallback-resilience.test.js',
  'tests/session-write-lock-invalidation.test.js',
