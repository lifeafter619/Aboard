...
window.translations = {
    ...
    errors: {
        ...
        invalidFile: 'Die ausgewählte Datei ist ungültig.'
    },
    ...
    browserCheck: {
        ...
        features: {
            ...
            modernSyntax: 'Moderne JavaScript-Syntax'
        }
    },
    // Recovery dialog
    recovery: {
    ...
    classroom: {
        ...
        pauseTimer: 'Stoppuhr pausieren',
        resetTimer: 'Stoppuhr zurücksetzen',
        stopwatch: 'Stoppuhr',
        actions: 'Unterrichtswerkzeuge',
        addPage: 'Neue Seite',
        countdown: 'Countdown',
    ...
    timer: {
        ...
        reset: 'Zurücksetzen',
        stop: 'Stoppen',
        audioFallback: 'Timer beendet (Ton nicht verfügbar)',
...
Viel Spaß bei Ihrer kreativen Arbeit!`,
    ...
    projectPackage: {
        ...
        tooComplex: 'Die Projektkomplexität überschreitet das sichere Importlimit.',
