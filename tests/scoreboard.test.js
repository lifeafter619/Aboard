...
function testInitialTitleAndTeamNameAreEscapedBeforeTemplateInsertion() {
  ...
  assert.equal(teamColumn.innerHTML.includes('&lt;svg onload=alert(1)&gt;'), true);
}

function main() {
  testInitialTitleAndTeamNameAreEscapedBeforeTemplateInsertion();
